...
export const MOCK_ANALYSIS_DATA = {
  ...
  translations: {
    ...
    te: 'ఈ పత్రం ఒక అధికారిక సమ్మతి పత్రం (Consent Form), ఇది కుటుంబ సభ్యుల ఆధార్ వివరాలను ఉపయోగించి మీ ఆధార్ కార్డ్‌లో మీ ఇంటి చిరునామాను అప్‌డేట్ చేయడానికి అనుమతిస్తుంది. మీ స్వంత చెల్లుబాటు అయ్యే చిరునామా రుజువు (కరెంట్ బిల్లు లేదా అద్దె ఒప్పందం వంటివి) లేనట్లయితే,加热 ఫారమ్‌ను ఉపయోగించవచ్చు. కొత్త చిరునామాలో నివసిస్తున్న దగ్గరి కుటుంబ సభ్యుడు (తండ్రి, తల్లి, భర్త, భార్య లేదా సంരક્ષకుడు వంటివారు) తప్పనిసరిగా ఈ ఫారమ్‌పై సంతకం చేయాలి. సంతకం చేయడం ద్వారా, వారు మీతో కలిసి నివసిస్తున్నారని официальగా ధృవీకరిస్తారు మరియు మీ ఆధార్ కార్డ్‌లో వారి चिరునామా వివరాలను పంచుకోవడానికి అంగీకరిస్తారు. ఈ ఫారమ్ చట్టబద్ధంగా కట్టుబడి ఉంటుంది, అంటే ఏదైనా తప్పుడు ప్రకటన చట్టపరమైన జరిమానాలకు దారి తీస్తుంది.',
